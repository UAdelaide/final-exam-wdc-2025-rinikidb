    ...
    const [rows] = await pool.query(`
      SELECT
        ...
        (
          ...
          JOIN WalkRequests w ON WalkApplications.request_id = w.request_id
          WHERE WalkApplications.walker_id = Users.user_id AND WalkApplications.status = 'accepted' AND w.status = 'completed'
        ) AS completed_walks
      FROM Users
